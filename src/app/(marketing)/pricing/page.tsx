        ...
        <div className="mt-12 grid gap-6 sm:mt-16 sm:gap-8 md:grid-cols-2 md:gap-8">
          ...
          <div className="rounded-2xl border-2 border-stone-200 bg-white p-5 sm:p-8">
            ...
            <SignedOut>
              <Link
                href="/sign-up"
                className="mt-8 flex min-h-[48px] w-full items-center justify-center rounded-xl border-2 border-stone-300 py-3 text-center font-semibold text-stone-900 transition-colors hover:border-amber-500 hover:bg-amber-50"
              >
                Get started
              </Link>
            </SignedOut>
          ...
          <div className="rounded-2xl border-2 border-amber-500 bg-amber-50/30 p-5 shadow-lg sm:p-8">
            ...
            <SignedOut>
              <Link
                href="/sign-up"
                className="mt-8 flex min-h-[48px] w-full items-center justify-center rounded-xl bg-amber-600 py-3 text-center font-semibold text-white transition-colors hover:bg-amber-700"
              >
                Start Pro
              </Link>
            </SignedOut>
