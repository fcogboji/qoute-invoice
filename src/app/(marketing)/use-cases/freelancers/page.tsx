...
export const metadata: Metadata = {
  title: "Invoice Software for Freelancers",
  description:
    "TradeInvoice helps freelancers create invoices and track payments easily. UK tradespeople.",
};
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-20">
      ...
      <p className="mt-6 text-lg text-[#0F2544]/70">
        Freelancers and self-employed tradespeople use TradeInvoice to send
        professional invoices, manage clients and track payments in one place.
      </p>
