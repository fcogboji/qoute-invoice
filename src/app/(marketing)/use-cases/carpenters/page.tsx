...
export const metadata: Metadata = {
  title: "Invoice Software for Carpenters",
  description:
    "TradeInvoice helps carpenters create invoices and track payments easily. UK tradespeople.",
};
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-20">
      <h1 className="text-3xl font-bold text-[#0F2544] md:text-4xl">
        Invoice Software for Carpenters
      </h1>

      <p className="mt-6 text-lg text-[#0F2544]/70">
        Carpenters use TradeInvoice to send professional invoices, manage
