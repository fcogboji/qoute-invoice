...
export const metadata: Metadata = {
  title: "Invoice Software for Electricians",
  description:
    "TradeInvoice helps electricians create invoices and track payments easily. UK tradespeople.",
};
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-20">
      ...
      <p className="mt-6 text-lg text-[#0F2544]/70">
        Electricians use TradeInvoice to send professional invoices, manage
